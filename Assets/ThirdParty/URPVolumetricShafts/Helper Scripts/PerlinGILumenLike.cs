...
public class PerlinGILumenLike
{
	const int B = 0x100;
	const int BM = 0xff;
	const int N = 0x1000;
...
public class FractalNoise
{
		...
		: this (inH, inLacunarity, inOctaves, null)
	{
		...
		public FractalNoise (float inH, float inLacunarity, float inOctaves, PerlinGILumenLike noise)
	{
	...
	private PerlinGILumenLike m_Noise;
