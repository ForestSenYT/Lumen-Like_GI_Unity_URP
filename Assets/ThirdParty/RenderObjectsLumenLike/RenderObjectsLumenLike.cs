...
namespace LumenLike
{
  ...
  //  [URPHelpURL("renderer-features/renderer-feature-render-objects")]
    public class RenderObjectsLumenLike : ScriptableRendererFeature
    {
        /// <summary>
        ...
        RenderObjectsPassLumenLike renderObjectsPass;
        ...
        public override void Create()
        {
            ...
            renderObjectsPass = new RenderObjectsPassLumenLike(settings.passTag, settings.Event, filter.PassNames,
                filter.RenderQueueType, filter.LayerMask, settings.cameraSettings, settings.isCascade);
            ...
            switch (settings.overrideMode)
            {
                case RenderObjectsSettings.OverrideMaterialMode.None:
                    ...
                    renderObjectsPass.isCascade = settings.isCascade;
                    break;
